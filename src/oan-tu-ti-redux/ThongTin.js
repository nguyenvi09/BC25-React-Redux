      ...
      <>
        ...
        <div className="row">
          <div className="col-4" style={{ color: "blue", fontSize: "35px" }}>
            Thắng:{" "}
            <span style={{ color: "#19b500" }}>{this.props.soBanThang}</span>
          </div>
          <div className="col-4" style={{ color: "blue", fontSize: "35px" }}>
            Hòa: <span style={{ color: "#bdb3b3" }}>{this.props.soBanHoa}</span>
          </div>
          <div className="col-4" style={{ color: "blue", fontSize: "35px" }}>
            Thua: <span style={{ color: "red" }}>{this.props.soBanThua}</span>
          </div>
        </div>
